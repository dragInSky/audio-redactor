...
class MainWindow:
    ...
    def setup_cut_layout(self):
        ...
        button_cut = QPushButton(parent=self.vertical_layout_widget)
    ...
    def setup_fragment_cut_layout(self):
        ...
        button_fragment = QPushButton(parent=self.vertical_layout_widget)
    ...
    def setup_append_layout(self):
        ...
        button_append = QPushButton(parent=self.vertical_layout_widget)
        ...
        self.push_button_append = QtWidgets.QPushButton(parent=self.vertical_layout_widget)
    ...
    def setup_overlay_layout(self):
        ...
        button_overlay = QPushButton(parent=self.vertical_layout_widget)
        ...
        self.push_button_overlay = QtWidgets.QPushButton(parent=self.vertical_layout_widget)
